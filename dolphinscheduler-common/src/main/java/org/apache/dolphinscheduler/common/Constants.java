...
public final class Constants {
     ...
     * rpc configurations
     */
    public static final String MESSAGE_SERVER_URL = "message.server.url";

    /**
     * sms alert type configurations
     */
    public static final String TASK_TIME_OUT = "0";
    public static final String PROCESS_TIME_OUT = "1";
