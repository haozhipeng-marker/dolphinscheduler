...
public class ResourcesController extends BaseController {
    ...
    /**
     * query resource by full name and userId
     *
     * @param loginUser login user
     * @param fullName  resource full name
     * @param type      resource type
     * @return true if the resource name not exists, otherwise return false
     */
    @ApiOperation(value = "queryResourceByFullName", notes = "QUERY_BY_RESOURCE_NAME")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "type", value = "RESOURCE_TYPE", required = true, dataType = "ResourceType"),
            @ApiImplicitParam(name = "fullName", value = "RESOURCE_FULL_NAME", required = true, dataType = "String")
    })
    @GetMapping(value = "/queryResourceByFullName")
    @ResponseStatus(HttpStatus.OK)
    @ApiException(RESOURCE_NOT_EXIST)
    public Result queryResourceByFullName(@ApiIgnore @RequestAttribute(value = Constants.SESSION_USER) User loginUser,@RequestParam(value = "fullName", required = true) String fullName,@RequestParam(value = "type") ResourceType type) {
        logger.info("login user {}, query resource by full name: {} or id: {},resource type: {}",
                loginUser.getUserName(), fullName, type);
        return resourceService.queryResourceByFullName(fullName,type,loginUser);
    }
     ...
     * @return true if the resource name not exists, otherwise return false
     */
    @ApiOperation(value = "queryResourceById", notes = "QUERY_BY_RESOURCE_ID")
    @ApiImplicitParam(name = "id", value = "RESOURCE_ID", required = true, dataType = "int")
    @GetMapping(value = "/queryResourceById")
    @ResponseStatus(HttpStatus.OK)
    @ApiException(RESOURCE_NOT_EXIST)
    public Result queryResourceById(@ApiIgnore @RequestAttribute(value = Constants.SESSION_USER) User loginUser,
                                @RequestParam(value = "id", required = false) Integer id) {
        logger.info("login user {}, query resource by id: {} ", loginUser.getUserName(), id);
