...
//  @TableId(value="id", type=IdType.AUTO)
  ...
  public Resource(int pid, String alias, String fullName, boolean isDirectory, String description, String fileName, int userId, ResourceType typeot, long sizeot, Date createTime, Date updateTime) {
    this.pid = pid;
    this.alias = alias;
    this.fullName = fullName;
    this.isDirectory = isDirectory;
  ...
  public void setType(ResourceType typeot) {
    this.typeot = typeot;
  }
