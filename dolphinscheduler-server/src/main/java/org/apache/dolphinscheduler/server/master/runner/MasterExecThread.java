...
public class MasterExecThread implements Runnable {
    ...
    private void endProcess() {
        ...
        //send sms warn result
        alertManager.sendSmsAlertProcessInstance(processInstance, taskInstances);
    }
    ...
    private void submitPostNode(String parentNodeName){
        ...
        for(String taskNode : submitTaskNodeList){
            taskInstances.add(createTaskInstance(processInstance, taskNode, dag.getNode(taskNode)));
        }
    ...
    private void runProcess(){
        ...
        while(!processInstance.isProcessInstanceStop()){
            ...
            if(!sendTimeWarning && checkProcessTimeOut(processInstance) ){
                ...
                //send mail time out
                alertManager.sendProcessTimeoutAlert(processInstance,processDefinition);
                //send sms time out
                alertManager.sendSmsProcessTimeoutAlert(processInstance,processDefinition);
            ...
            if(CollectionUtils.isNotEmpty(this.recoverToleranceFaultTaskList)){
                ...
                //send sms
                alertManager.sendSmsAlertWorkerToleranceFault(processInstance, recoverToleranceFaultTaskList);
     ...
     * @throws Exception            exception
     */
    public ProcessDag generateFlowDag(String processDefinitionJson, List<String> startNodeNameList,
                                      List<String> recoveryNodeNameList, TaskDependType depNodeType)throws Exception{
