...
public class ProcessService {
    ...
    public void moveToErrorCommand(Command command, String message) {
        ...
        errorCommand.setId(errorCommandMapper.getMaxId());
    ...
    public int createCommand(Command command) {
        int result = 0;
        if (command != null){
            command.setId(commandMapper.getMaxId());
    ...
    public void createProcessInstance(ProcessInstance processInstance){
        ...
        if (processInstance != null){
            processInstance.setId(processInstanceMapper.getMaxId());
    ...
    public boolean createTaskInstance(TaskInstance taskInstance) {
        taskInstance.setId(taskInstanceMapper.getMaxId());
    ...
    public int createWorkProcessInstanceMap(ProcessInstanceMap processInstanceMap){
        ...
        if(processInstanceMap !=null){
            processInstanceMap.setId(processInstanceMapMapper.getMaxId());
